<template>
  <div class="bg-gray-50 dark:bg-black py-12 border-t dark:border-neutral-800">
    <div class="container mx-auto px-4">
      <div class="text-center mb-12">
        ...
        <p
          class="text-xl text-gray-600 dark:text-neutral-300 max-w-2xl mx-auto leading-relaxed"
        >
