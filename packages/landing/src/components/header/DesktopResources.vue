          ...
          <div class="p-6 border-r border-gray-100 dark:border-neutral-700">
            ...
            <div class="space-y-2">
              <NavigationMenuLink
                ...
                class="block select-none rounded-md leading-none no-underline outline-none transition-colors hover:bg-gray-50 dark:hover:bg-neutral-800 hover:text-gray-900 dark:hover:text-white focus:bg-gray-50 dark:focus:bg-neutral-800 focus:text-gray-900 dark:focus:text-white p-2"
              >
