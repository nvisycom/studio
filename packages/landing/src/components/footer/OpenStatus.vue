...
<template>
  <a
    ...
    class="inline-flex items-center space-x-3 group px-3 py-2 bg-gray-50 dark:bg-neutral-900 rounded-lg border border-gray-200 dark:border-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-800 transition-all duration-300 no-underline"
