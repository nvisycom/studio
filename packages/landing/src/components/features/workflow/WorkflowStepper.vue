  ...
  <div class="max-w-4xl mx-auto mb-16">
    ...
    >
      <StepperItem
        ...
        :key="step.number"
        :step="step.number"
        class="relative flex-1 group flex flex-col"
      >
        <StepperTrigger
          class="flex flex-col items-center text-center w-full flex-1"
        >
          <div class="relative z-10 mb-6 flex-shrink-0">
            <StepperIndicator
        ...
        <StepperSeparator
          ...
          class="hidden lg:block absolute top-6 left-[calc(50%+24px)] w-[calc(100%)] h-0.5 bg-gray-300 dark:bg-neutral-600 data-[state=completed]:bg-gray-900 dark:data-[state=completed]:bg-white transition-colors duration-300"
        />
      </StepperItem>
    </Stepper>
  </div>
