...
import { Cloud, Cpu, Send, Check, Calendar } from "lucide-vue-next";
    ...
    <div class="space-y-6 relative overflow-hidden h-full">
      <div v-for="(step, index) in steps" :key="step.id" class="relative">
        ...
        <div class="flex items-center gap-4 mb-4">
          <div
            class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 z-10 bg-gray-100 dark:bg-neutral-900 transition-all duration-300"
          >
            <Spinner
