      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div class="space-y-4">
          <div class="flex items-center space-x-2">
            <span class="font-bold text-lg">Nvisy</span>
          </div>
      ...
      <div class="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
        <div class="flex flex-col items-center space-y-4 md:flex-row md:space-x-4 md:space-y-0">
          <p class="text-sm text-muted-foreground">
            © {{ currentYear }} Nvisy. All rights reserved.
          </p>
          <!-- Legal links would go here -->
        </div>

        <!-- Social Links -->
        <div class="flex items-center space-x-4">
          <a
            href="https://twitter.com/nvisy"
            target="_blank"
            rel="noopener noreferrer"
            class="text-muted-foreground transition-colors hover:text-foreground"
...
import { Separator } from "@nvisy/shared/ui/separator";
