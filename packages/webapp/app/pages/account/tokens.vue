...
definePageMeta({
	breadcrumbs: [{ label: "[account]" }, { label: "Tokens" }],
});
    ...
    <div class="max-w-4xl mx-auto w-full">
      ...
      <div class="mb-8">
        ...
        <p class="text-neutral-600 dark:text-neutral-400">
          Manage your tokens for programmatic access
        </p>
      </div>
      ...
      <Card class="mb-8 py-0 pt-6 rounded-xl">
        <CardHeader>
          ...
          <CardDescription>Generate a new API token for accessing your account</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger as-child>
                  <Button variant="outline" class="w-full justify-between">
                    {{ expirations.find(e => e.value === tokenExpiration)?.label }}
                    <ChevronDown :size="16" />
                  </Button>
                </DropdownMenuTrigger>
      ...
      <Card class="overflow-hidden py-0 pt-6 rounded-xl">
        <CardHeader>
          ...
          <CardDescription>
            {{ tokens.length }} {{ tokens.length === 1 ? 'token' : 'tokens' }} in use
          </CardDescription>
        </CardHeader>
        <CardContent>
          <TokensTable
        ...
        <CardFooter class="border-t pb-6 bg-neutral-50 dark:bg-neutral-900 rounded-b-xl">
          <p class="text-sm text-neutral-600 dark:text-neutral-400">
            Tokens provide access to your account. Keep them secure and rotate them regularly.
          </p>
        </CardFooter>
      </Card>
