  ...
  <Table>
    <TableHeader>
      <TableRow>
        ...
        <TableHead>{{ t('integrations.table.headers.events') }}</TableHead>
        <TableHead>{{ t('integrations.table.headers.lastDelivery') }}</TableHead>
      ...
      >
        <TableCell>
          <div class="min-w-0">
            ...
            <p class="text-xs text-neutral-600 dark:text-neutral-400 truncate font-mono">{{ formatUrl(webhook.url) }}</p>
          </div>
        </TableCell>
        <TableCell>
