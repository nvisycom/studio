...
import type { CreateWorkspaceProvider, LlmConfig } from "@nvisy/sdk/datatypes";
...
const emit = defineEmits<{
	...
	(e: "connect", provider: CreateWorkspaceProvider): void;
}>();
...
function submit() {
	...
	emit("connect", {
		...
		config,
	} satisfies CreateWorkspaceProvider);
}
</script>
