...
/**
 * The workspace's connection sync runs — a filterable table of every sync, with
 * an inline cancel for the ones still in flight. Rendered inside the "View runs"
 * dialog on the Connections page (no page chrome of its own).
 */
const { t } = useI18n();
